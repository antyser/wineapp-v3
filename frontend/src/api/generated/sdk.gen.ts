 ...
 * Delete a note
 */
export const deleteNoteEndpointApiV1NotesNoteIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteNoteEndpointApiV1NotesNoteIdDeleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteNoteEndpointApiV1NotesNoteIdDeleteResponse, DeleteNoteEndpointApiV1NotesNoteIdDeleteError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const updateNoteEndpointApiV1NotesNoteIdPatch = <ThrowOnError extends boolean = false>(options: Options<UpdateNoteEndpointApiV1NotesNoteIdPatchData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<UpdateNoteEndpointApiV1NotesNoteIdPatchResponse, UpdateNoteEndpointApiV1NotesNoteIdPatchError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Upsert a Tasting Note
 * Creates a new note or updates an existing one based on the provided data, including an optional note_id.
 */
...
/**
 * Upsert User Wine Interaction
 * Upsert (create or update) a user's interaction with a specific wine.
 * Requires authentication.
 */
export const upsertUserWineInteractionApiV1InteractionsUserWineIdPost = <ThrowOnError extends boolean = false>(options: Options<UpsertUserWineInteractionApiV1InteractionsUserWineIdPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UpsertUserWineInteractionApiV1InteractionsUserWineIdPostResponse, UpsertUserWineInteractionApiV1InteractionsUserWineIdPostError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Standard Wine Chat (Request/Response)
 * Process a wine chat request and return the complete response at once.
 */
export const wineChatStandardApiV1ChatWinePost = <ThrowOnError extends boolean = false>(options: Options<WineChatStandardApiV1ChatWinePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<WineChatStandardApiV1ChatWinePostResponse, WineChatStandardApiV1ChatWinePostError, ThrowOnError>({
...
/**
 * Streaming Wine Chat
 * Process a wine chat request and stream the response token by token using Server-Sent Events (SSE).
 */
export const wineChatStreamApiV1ChatWineStreamPost = <ThrowOnError extends boolean = false>(options: Options<WineChatStreamApiV1ChatWineStreamPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, WineChatStreamApiV1ChatWineStreamPostError, ThrowOnError>({
